...
def get_df():
    ...
    weibo=shuffle(weibo)
    return weibo['text'].values.tolist(), weibo['rumor'].values.tolist(), weibo['comments'].values.tolist(),weibo['likes'].values.tolist(),weibo['reposts'].values.tolist()
